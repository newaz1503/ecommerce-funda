...
<section id="shop">
    <div class="container-fluid">
        <h1 class="title mb-5 text-center p-3">{{ $brand_product->name ?? '' }}</h1>
        ...
        <div class="row">
            <div class="col-12 col-mg-6 col-lg-3">
                <div class="left_sidebar">
                    <!-- categories -->
                    <div class="category">
                        <h3 class="shop_sidebar_title">Product Brand</h3>
                    ...
                    <div class="brand">
                        ...
                        <div class="brands_items">
                            <ul>
                                ...
                                @empty
                                    <div class="bg-danger text-white text-center p-2">Brands Not Found</div>
                                @endforelse
