...
@section('title')
    {{ $category_product->meta_title ?? ''}}
@endsection
@section('meta_description')
{{ $category_product->meta_description ?? ''}}
@endsection
@section('meta_keyword')
{{ $category_product->meta_keyword ?? ''}}
@endsection
@push('css')
...
<section id="shop">
    <div class="container-fluid">
        <h1 class="title mb-5 text-center p-3">{{ $category_product->name ?? '' }}</h1>
                ...
                <div class="left_sidebar">
                    ...
                    <div class="brand">
                        ...
                        <div class="brands_items">
                            <ul>
                                @forelse ($category_product->brands as $brand)
                                <li class="brand_item">
            ...
            <div class="col-12 col-mg-6 col-lg-9">
                ...
                <div class="shop_product">
                    <div class="row row-cols-1 row-cols-md-4 g-2 pt-3">
                        @forelse($category_product->products as $product)
                            <div class="col h-100">
                                <div class="product">
