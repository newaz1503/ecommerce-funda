        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <a href="{{ route('admin.slider.create') }}" class="btn btn-info d-none d-lg-block m-l-15"><i
                            class="fa fa-plus-circle"></i> Create New slider</a>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
                                ...
                                <tbody>
                                    @foreach ($sliders as $key=>$slider)
                                        <tr>
                                            ...
                                            <td>{{ $slider['title'] }}</td>
                                            <td>
                                                <img src="{{ asset('uploads/images/slider/'.$slider['image']) }}" alt="{{ $slider['name'] }}" width="60" >
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.slider.edit', $slider->id) }}" class="btn btn-primary btn-sm">
