    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Edit Brand</h4>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="mt-4" method="post" action="{{ route('admin.brand.update', $brand->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="custom-control custom-checkbox mr-sm-2 mb-3">
                                <input type="checkbox" name="status" {{ $brand->status == true ? 'checked' : '' }} class="custom-control-input" id="checkbox0"
                                    value="check">
