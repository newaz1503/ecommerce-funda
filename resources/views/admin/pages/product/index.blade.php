        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <a href="{{ route('admin.product.create') }}" class="btn btn-info d-none d-lg-block m-l-15"><i
                                ...
                                <tbody>
                                    @foreach ($products as $key=>$product)
                                        <tr>
                                            ...
                                            <td>{{ $product['name'] }}</td>
                                            <td>
                                                <img src="{{ asset('uploads/images/product/'.$product->productImages[0]->image) }}" alt="{{ $product['name'] }}" width="60" class="rounded">
                                            </td>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.color.editcolor', $product->id) }}" class="btn btn-primary btn-sm">
