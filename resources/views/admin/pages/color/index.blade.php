        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <a href="{{ route('admin.color.create') }}" class="btn btn-info d-none d-lg-block m-l-15"><i
                            class="fa fa-plus-circle"></i> Create New Color</a>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
                                ...
                                <tbody>
                                    @foreach ($colors as $key=>$color)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ date('M j, Y', strtotime($color['created_at'])) }} </td>
                                            <td>
                                                <a href="{{ route('admin.color.edit', $color->id) }}" class="btn btn-primary btn-sm">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <button class="btn btn-danger btn-sm" onclick="deletColor({{$color->id}})">
